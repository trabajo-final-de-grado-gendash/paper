...
La implementación de sistemas de GenBI
...
vectorial. Cuando un usuario hace una pregunta, el sistema busca matemáticamente
...
Evaluar la calidad de un sistema de GenBI
